...
var _tmpl$$43 = /* @__PURE__ */ solid_js_web.template(\`<select>\`), _tmpl$2$9 = /* @__PURE__ */ solid_js_web.template(\`<option>\`);
/** 选择器式菜单项 */
...
var _tmpl$$37 = /* @__PURE__ */ solid_js_web.template(\`<img draggable=false decoding=sync>\`), _tmpl$2$8 = /* @__PURE__ */ solid_js_web.template(\`<div>\`), _tmpl$3$3 = /* @__PURE__ */ solid_js_web.template(\`<div><picture>\`);
const ComicImg = (img) => {
	...
	const ComicImgBase = (props) => (() => {
		...
		solid_js_web.effect((_p$) => {
			var _v$4 = classes$1.img, _v$5 = \`_\${img.index}_\${props.cloneIndex ?? 0}\`, _v$6 = styles().img, _v$7 = showState(), _v$8 = img.type ?? store.defaultImgType, _v$9 = img.loadType === "loaded" ? void 0 : img.loadType, _v$0 = styles().picture;
...
var _tmpl$$34 = /* @__PURE__ */ solid_js_web.template(\`<div>\`), _tmpl$2$7 = /* @__PURE__ */ solid_js_web.template(\`<div role=button tabindex=-1>\`);
const areaArrayMap = {
	left_right: [
		[
			"prev",
...
var _tmpl$$33 = /* @__PURE__ */ solid_js_web.template(\`<div>\`), _tmpl$2$6 = /* @__PURE__ */ solid_js_web.template(\`<div role=button tabindex=-1><div><p></p><button type=button></button><button type=button data-is-end></button><button type=button>\`), _tmpl$3$2 = /* @__PURE__ */ solid_js_web.template(\`<p>\`);
...
var _tmpl$$31 = /* @__PURE__ */ solid_js_web.template(\`<div role=scrollbar tabindex=-1>\`), _tmpl$2$5 = /* @__PURE__ */ solid_js_web.template(\`<div>\`);
/** 滚动条 */
const Scrollbar = () => {
	solid_js.onMount(() => {
		helper.useDrag({
...
var _tmpl$$4 = /* @__PURE__ */ solid_js_web.template(\`<input type=color style=width:2em;margin-right:.4em>\`), _tmpl$2$2 = /* @__PURE__ */ solid_js_web.template(\`<blockquote><p>\`);
/** 默认菜单项 */
		...
		const Popper = solid_js_web.createComponent(solid_js.Show, {
			...
			get children() {
				return [solid_js_web.createComponent(SettingPanel, {}), (() => {
					...
					solid_js_web.effect(() => solid_js_web.className(_el$4, classes$1.closeCover));
					return _el$4;
				})()];
			}
		});
...
const useInit = async (name, initSiteOptions = {}) => {
	...
	const init = (autoShow = true) => {
		...
		(async () => {
			console.debug(helper.t("other.enter_comic_read_mode"), () => void showComic());
	...
	const updateHideFabMenu = async () => {
		...
		menuId = console.debug(options.hiddenFab ? helper.t("other.fab_show") : helper.t("other.fab_hidden"), () => {
	...
	switch (location.hostname) {
		...
		case "manhua.zaimanhua.com": {
			...
			core.setup({
				...
				getImgList: async () => {
					const nuxtImgList = unsafeWindow.__NUXT__?.data?.getChapters?.data?.chapterInfo?.page_url;
